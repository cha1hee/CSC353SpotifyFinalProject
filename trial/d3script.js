  ...
  chart: function () {
    ...
    function radar(selection) {
      selection.each(function (data) {
        ...
        var tt = tooltip.enter().append("g").classed("tooltip", true);
          ...
          levelLine
            ...
            .attr("x1", function (levelFactor, i) {
              if (radius == levelFactor) {
                ...
                return (
                  getHorizontalPosition(i, levelFactor) +
                  (cfg.TickLength / 2) * Math.cos((i * cfg.radians) / total)
                );
              }
            })
            .attr("y1", function (levelFactor, i) {
              if (radius == levelFactor) {
                ...
                return (
                  getVerticalPosition(i, levelFactor) -
                  (cfg.TickLength / 2) * Math.sin((i * cfg.radians) / total)
                );
              }
            })
            ...
            axis
              ...
              .attr("x2", function (d, i) {
                return (
                  cfg.w / 2 -
                  radius2 +
                  getHorizontalPosition(i, radius2, cfg.factor)
                );
              })
              .attr("y2", function (d, i) {
                return (
                  cfg.h / 2 -
                  radius2 +
                  getVerticalPosition(i, radius2, cfg.factor)
                );
              });
          }
          ...
          if (cfg.axisText) {
            axis
              ...
              .attr("class", function (d, i) {
                ...
                return (
                  "legend " + (p < 0.4 ? "left" : p > 0.6 ? "right" : "middle")
                );
              })
              ...
              .attr("x", function (d, i) {
                return (
                  d.xOffset +
                  (cfg.w / 2 - radius2) +
                  getHorizontalPosition(i, radius2, cfg.factorLegend)
                );
              })
              .attr("y", function (d, i) {
                return (
                  d.yOffset +
                  (cfg.h / 2 - radius2) +
                  getVerticalPosition(i, radius2, cfg.factorLegend)
                );
              });
          }
        }
          ...
          d.axes.forEach(function (axis, i) {
            axis.x =
              ...
              getHorizontalPosition(
                i,
                radius2,
                (parseFloat(Math.max(axis.value - cfg.minValue, 0)) /
                  maxValue) *
                  cfg.factor
              );
            axis.y =
